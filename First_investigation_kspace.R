...
plot(df$wf, abs(df$fy), type= 'l', col=rgb(0,0,1,0.25), xlim = c(19,24), xlab = 'w', ylab = 'abs', sub = 'Magnitude spectrum')
plot(df$wf, Arg(df$fy), type= 'l', col=rgb(0,0,1,0.25), xlim = c(19,24), xlab = 'w', ylab = 'phase', sub = 'Phase spectrum')

#First_investigation_kspace_bubble
plot(df$wf, abs(df$fy), type= 'l', col=rgb(0,0,1,0.25), xlab  = 'w', ylab = 'abs', sub = 'Magnitude spectrum')
plot(df$wf, Arg(df$fy), type= 'l', col=rgb(0,0,1,0.25), xlab  = 'w', ylab = 'phase', sub = 'Phase spectrum')
plot(df$wf, abs(df$fy), type= 'b', col=rgb(0,0,1,0.25), xlim = c(19,24), xlab = 'w', ylab = 'abs', sub = 'Magnitude spectrum')
plot(df$wf, Arg(df$fy), type= 'b', col=rgb(0,0,1,0.25), xlim = c(19,24), xlab = 'w', ylab = 'phase', sub = 'Phase spectrum')
